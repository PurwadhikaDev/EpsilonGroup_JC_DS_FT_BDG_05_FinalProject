...
**Tools**
  ...
  - Pandas
  - XGBoost
  - Streamlit https://e-commerce-customer-churn-prediction.streamlit.app/ (dataset bisa dilihat di folder data set atau streamlit dengan nama file: E commerce.csv)
